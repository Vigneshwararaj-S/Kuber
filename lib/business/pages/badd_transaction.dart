...
import '../contents/bcategories.dart';
import '../controllers/Bdb_helper.dart';
import 'bhome_page.dart';

class BAddExpenseNoGradient extends StatefulWidget {
  const BAddExpenseNoGradient({Key? key}) : super(key: key);

  @override
  _BAddExpenseNoGradientState createState() => _BAddExpenseNoGradientState();
}

class _BAddExpenseNoGradientState extends State<BAddExpenseNoGradient> {
              ...
              Row(
                children: [
                  DropdownButton<String>(
                    ...
                    items: bcategories.map<DropdownMenuItem<String>>((String value) {
                  ...
                  onPressed: () {
                    setState(() {
                      if(_controller.text.isNotEmpty){
                        bcategories.add(_controller.text);
                        _controller.clear();
                      } else{
            ...
            child: ElevatedButton(
              onPressed: () {
                if (amount != null) {
                  ...
                  dbHelper.baddData(amount!, selectedDate, type, note, dropdownValue);
                  if (kDebugMode) {
                    print(amount);
                  }
                  print(type);
