...
class BMonthly extends StatefulWidget {
  const BMonthly({Key? key}) : super(key: key);

  @override
  _BMonthlyState createState() => _BMonthlyState();
}

class _BMonthlyState extends State<BMonthly> {
  //
  late Box box;
