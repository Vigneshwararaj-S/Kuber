...
class BYearly extends StatefulWidget {
  const BYearly({Key? key}) : super(key: key);

  @override
  _BYearlyState createState() => _BYearlyState();
}

class _BYearlyState extends State<BYearly> {
  //
  late Box box;
  ...
  List<FlSpot> getPlotPoints(List<TransactionModel> entireData) {
    ...
    for (TransactionModel item in entireData) {
      if (item.date.year == today.year  && item.type == "Expense") {
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (dataAtIndex.date.year  == today.year) {
                ...
                InkWell(
                  onTap: () {
                    setState(() {
                      ...
                      if (index > carrys)
                      {
                        today = DateTime(today.year - (index - carrys), today.month , today.day );
                        carrys = index;
                      }
                      else if (index < carrys)
                      {
                        today = DateTime(today.year + (carrys - index), today.month  , today.day);
                        carrys = index;
                      }
                    });
                  },
